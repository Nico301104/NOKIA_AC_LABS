...
BEGIN
    ...
    -- Validare: Dacă ID-ul trimis nu există în tabelă, oprim procedura
    ...
    SET 
        ...
        -- Dacă statusul devine 'Resolved', salvăm data curentă, altfel lăsăm ce era înainte
        RESOLVED_DATETIME = CASE WHEN @StatusName = 'Resolved' THEN GETDATE() ELSE RESOLVED_DATETIME END,
        
        -- Dacă statusul devine 'Closed', salvăm data curentă, altfel lăsăm ce era înainte
